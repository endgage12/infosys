...
Работали над программой:
    Александр Полынянкин, студент ТУСУРа 3-го курса направления "Прикладная информатика" в рамках учебной дисциплины "Информационный менеджмент".
    Контакты:
        github: https://github.com/endgage12
        discord: polyana #3822
            </pre>
        </div>
    </body>
</html>