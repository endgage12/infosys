        ...
        <div class="main">
            <div id="block1">
                <form action="" method="POST">
                    ...
                    <p>Инвентарный номер </p> <ul class="lst"> <li><input class="inputNew" type="number" name="temp0" placeholder="Инвентарный номер" min="1"></li> <li><div class="hint">Например: 702, 703, 704...</div></li> </ul> <hr> <br>
